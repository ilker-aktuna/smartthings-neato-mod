...
metadata {
	...
	tiles(scale: 2) {
        ...
        standardTile("switch", "device.switch", width: 2, height: 2, decoration: "flat") {
         ...
         standardTile("presence", "device.presence", width: 2, height: 2, canChangeIcon: true,  backgroundColor:"#ffffff") {
			state ("present", label: "UP", icon: "st.Office.office9", backgroundColor:"#00aa33")
			state ("not present", label: "DOWN", icon: "st.Office.office9", backgroundColor:"#ffffff")
		}
        
        standardTile("creatcleanbuttons", "device.switch", width: 2, height: 2, inactiveLabel: false, canChangeIcon: false, decoration: "flat") {
		...
		main("switch")
		details(["clean","smartScheduleStatusMessage", "forceCleanStatusMessage", "status", "battery", "charging", "bin", "dockStatus", "dockHasBeenSeen", "cleaningMode", "navigationMode", "persistentMapMode", "scheduled", "resetSmartSchedule", "network", "refresh", "presence", "creatcleanbuttons", "mapHTML"])
	}
}
